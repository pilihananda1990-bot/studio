...
import { Newspaper, Archive, Trash2, GlassWater, Leaf, Wallet, MapPin } from "lucide-react";
import type { Category, RecyclableItem, Province, City, Subdistrict, Village, Transaction, RedemptionCategory, Notification } from "./types";
...
export const redemptionCategories: RedemptionCategory[] = [
  {
    ...
    name: 'E-Wallets',
    items: [
      { id: 'dana-5', name: 'DANA Balance $5', points: 5000, icon: '/wallet-icons/dana.svg' },
      { id: 'ovo-5', name: 'OVO Balance $5', points: 5000, icon: '/wallet-icons/ovo.svg' },
      { id: 'gopay-5', name: 'GoPay Balance $5', points: 5000, icon: '/wallet-icons/gopay.svg' },
      { id: 'dana-10', name: 'DANA Balance $10', points: 10000, icon: '/wallet-icons/dana.svg' },
    ]
  },
  {
    id: 'vouchers',
    name: 'Vouchers',
    items: [
      { id: 'gofood-5', name: 'GoFood Voucher $5', points: 5000, icon: '/wallet-icons/gofood.svg' },
      { id: 'tokopedia-10', name: 'Tokopedia Voucher $10', points: 10000, icon: '/wallet-icons/tokopedia.svg' },
      { id: 'shopee-5', name: 'Shopee Voucher $5', points: 5500, icon: '/wallet-icons/shopee.svg' },
    ]
  }
];
